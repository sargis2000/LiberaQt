...
2. **Is migrating existing suites a goal?** A converter that mechanically translates another tool's
   scripts and object maps is worth roughly a milestone of its
