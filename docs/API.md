...
qd.attach(pid=..., port=...) -> Application          # v0.3
```
...
expect(app).to_have_no_window(title="Splash")
```
...
```python
expect(win).to_match_screenshot("login.png", threshold=0.02)
```
