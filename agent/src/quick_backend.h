...
public:
    ...
    // Whether the object is a QQuickItem, asked from code that cannot include Quick
    // headers itself because it also has to compile without them.
    static bool isItem(const QObject *object);
